...
/* Becomes a spring bean an gets registered to SpringContext
   Behind the scenes, when the spring context is completely up it will
   see that this is CommandLineRunner and it will call this 'run' method.*/
@Component
